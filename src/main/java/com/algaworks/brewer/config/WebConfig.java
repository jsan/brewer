...
//	}
	...
	// cacheando os combos cidade/estado
	@Bean 
	public CacheManager cacheManager() {
		CacheBuilder<Object, Object> cacheBuilder = CacheBuilder.newBuilder()
				.maximumSize(3) // will storage only 3 estados (in case of the method list cidades. estado is the input parameter) )
				.expireAfterAccess(20, TimeUnit.SECONDS); // 20 second is a short time test 
	...
	/**
	 * Padronizando menssagens de erro com o arquivo messages.properties
	 * link para caracteres especiais: http://www.utf8-chartable.de/ 
	 */
	@Bean
