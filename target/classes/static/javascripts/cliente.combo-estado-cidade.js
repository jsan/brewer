...
Brewer.ComboCidade = (function() {
	...
	function ComboCidade(comboEstado) {
		...
		this.codigoHiddenCidadeSelecionada = $('#codigoHiddenCidadeSelecionada');
	}
	...
	function onEstadoAlterado(evento, codigoEstado) {
		console.log('entrou aqui: ', codigoEstado);
		this.codigoHiddenCidadeSelecionada.val('');
		inicializarCidades.call(this,codigoEstado);
	}
	...
	function onBuscarCidadesFinalizado(cidades) {
		...
		var codigoCidadeSelecionada = this.codigoHiddenCidadeSelecionada.val();
